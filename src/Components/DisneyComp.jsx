...
import disney from '../videos/disney2.mp4'
...
const DisneyComp = () => {
    ...
    return (
        <>
            <VideoContainer>
                <video src={disney} autoPlay="autoplay" muted playsInline>
                </video>
            </VideoContainer>
            <MoviesContainer style={{paddingTop:"30px"}}>
                <Movies title={"Originals"} Movies={recommandMovies} />
                <Movies title={"Live Action Movies"} Movies={disneyMovies} />
                <Movies title={"Walt Disney Animation Studios"} Movies={PixarMovies} />
            </MoviesContainer>
        </>
    )
}
