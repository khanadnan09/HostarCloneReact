...
import MARVEL from '../videos/marvel2.mp4'
...
const MarvelComp = () => {
    ...
    return (
        <>
            <VideoContainer>
                <video src={MARVEL} autoPlay="autoplay" muted playsInline>
                </video>
            </VideoContainer>
            <MoviesContainer style={{paddingTop:"30px"}}>
                <Movies title={"Marvel Cinematic Universe"} Movies={recommandMovies} />
                <Movies title={"Marvel Legacy Movies"} Movies={disneyMovies} />
